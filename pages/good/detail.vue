<template>
  <view class="container">
    <block v-if="!loading && goodsInfo.id">
...
<style lang="scss" scoped>
  ...
  .tags-row { display: flex; flex-wrap: wrap; gap: 12rpx; margin-bottom: 24rpx; 
  ...
  .meta-row { background-color: #fafafa; padding: 20rpx; border-radius: 8rpx; 
    .meta-item { display: flex; margin-bottom: 10rpx; font-size: 26rpx; 
  ...
  .desc-section { background: #fff; padding-bottom: 40rpx; 
    .section-title { padding: 30rpx 0; text-align: center; font-size: 28rpx; color: #999; display: flex; justify-content: center; align-items: center; 
      &::before, &::after { content: ''; width: 60rpx; height: 1px; background: #eee; margin: 0 20rpx; } 
    } 
    .detail-img { width: 100%; display: block; } 
    .empty-desc { text-align: center; padding: 50rpx; color: #ccc; } 
  }
  
  .action-bar { position: fixed; bottom: 0; left: 0; right: 0; background: #fff; height: 100rpx; display: flex; align-items: center; padding: 0 20rpx; box-shadow: 0 -2rpx 10rpx rgba(0,0,0,0.05); z-index: 99; padding-bottom: constant(safe-area-inset-bottom); padding-bottom: env(safe-area-inset-bottom); 
    .total-info { flex: 1; font-size: 28rpx; 
      .label { color: #333; margin-right: 10rpx; } 
      .price { color: #ff4400; font-weight: bold; font-size: 32rpx; } 
    } 
    .btn-group { display: flex; height: 72rpx; 
      button { margin: 0; padding: 0 30rpx; line-height: 72rpx; font-size: 28rpx; border-radius: 0; &::after { border: none; } } 
      .btn-cart { background: #ffaa00; color: #fff; border-top-left-radius: 36rpx; border-bottom-left-radius: 36rpx; } 
      .btn-buy { background: #ff4400; color: #fff; border-top-right-radius: 36rpx; border-bottom-right-radius: 36rpx; } 
    } 
  }
