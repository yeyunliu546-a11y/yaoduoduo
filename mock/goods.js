...
// 1. 模拟的数据库 (数据扩充至 30+ 条，重点丰富瓶装/盒装，移除企标)
const dbGoods = [
    // --- 华润三九 ---
    ...
    { id: 106, goodsName: '大活络丹', manufacturer: '北京同仁堂', standard: '国标', packageType: '大包', spec: '3.5g*10丸', salePrice: 35.00, sales: 600, imageUrl: '/static/logo.png' }, // 修改为国标
    ...
    { id: 109, goodsName: '创可贴', manufacturer: '云南白药', standard: '国标', packageType: '小包', spec: '100片/盒', salePrice: 5.00, sales: 9999, imageUrl: '/static/logo.png' }, // 修改为国标
